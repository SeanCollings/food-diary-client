...
export const THEME_DARK_1: TApplicationTheme = {
  ...
  themes: {
    ...THEMES_DARK_STATIC,
    '--th-primary': '#F96F5D',
    '--th-primary__80': `#F96F5D${OPACITY_80}`,
    '--th-primary__40': `#F96F5D${OPACITY_40}`,
    '--th-secondary': '#2A8B81',
    '--th-secondary__80': `#2A8B81${OPACITY_80}`,
    '--th-secondary__40': `#2A8B81${OPACITY_40}`,
    '--th-tertiary': ' #E42A5A',
    '--th-tertiary__80': `#E42A5A${OPACITY_80}`,
    '--th-tertiary__40': `#E42A5A${OPACITY_40}`,
  },
  toThemeString,
};
